      ...
      <div className="container">
        <div className="layout">
          ...
          <aside className={`sidebar ${menuOpen ? '' : 'hidden-mobile'}`}>
            <img src="/img_vayuz_logo_1.png" alt="VAYUZ Logo" className="logo" />
            ...
            <img src="/img_rectangle_143.png" alt="Development" className="dev-image" />
          ...
          <main>
            ...
            <section className="flutter-dawn">
              ...
              <button>
                Begin
                <img src="/img_arrowupright_1.svg" alt="Arrow" />
              </button>
            </section>
                  ...
                  {services.map(service => (
                    ...
                    >
                      <h3>
                        {service.name}
                        <img
                          src={expandedService === service.name ? "/img_minus_1.svg" : "/img_plus_1_1.svg"}
